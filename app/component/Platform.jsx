...
export default function Platform () {
    return (
        <div className="flex w-full lg:max-w-[40%] flex-col dark:border-[#262626] bg-white dark:bg-[#171717] row-start-3 row-span-3 col-start-4 col-end-6 border border-[#edf2f7] gap-5 py-4 px-5 rounded-[14px]"> 
